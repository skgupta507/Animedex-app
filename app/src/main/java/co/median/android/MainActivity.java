...
public class MainActivity extends AppCompatActivity implements Observer,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vm = new ViewModelProvider(this, factory).get(SavedStateViewModel.class);
        if (vm.state.contains(SAVED_STATE_WEBVIEW_STATE)) {
            Bundle webViewStateBundle = vm.state.get(SAVED_STATE_WEBVIEW_STATE);
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        // Saves current WebView's history and URL or loaded page state to a new bundle
        Bundle webViewOutState = new Bundle();
        mWebview.saveStateToBundle(webViewOutState);
        // Initialize ViewModel for WebView state/configuration changes
        SavedStateViewModelFactory factory = new SavedStateViewModelFactory(getApplication(), this);
        vm = new ViewModelProvider(this, factory).get(SavedStateViewModel.class);
        // Save the new WebView state bundle to a ViewModel
        vm.state.set(SAVED_STATE_WEBVIEW_STATE, webViewOutState);

        // Save other WebView data to the bundle
